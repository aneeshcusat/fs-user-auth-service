...
import com.fs.service.auth.security.services.UserDetailsServiceImpl;
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    try {
      ...
      if (jwtUtils.validateJwtToken(authToken)) {
        String emailId = jwtUtils.getEmailIdFromJwtToken(authToken);
        ...
        throw new SecurityException(BaseException.ErrorCode.USER_INVALID_CREDENTIALS);
    } catch (Exception e) {
